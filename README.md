...
現在のバージョン：**v3.7**（更新履歴は [CHANGELOG.md](./CHANGELOG.md) を参照）
...
- 電話番号：本社 050-6882-7183／携帯 080-1246-8873（お問い合わせページのみ両方掲載、他は本社番号のみ）
...
`news.html` に4件の記事を掲載しています（新しい順）。
1. 2026年7月1日掲載：「時代は全室空調からエリア空調へ！工場の空調費削減のカギ」
2. 2026年4月10日掲載：「高圧・特別高圧の電気料金メニューが見直されました（2026年4月～）」
3. 2025年6月1日施行「職場の熱中症予防対策の義務化」について
4. 2024年4月1日施行「省エネ法改正による大規模建築物の省エネ基準引き上げ」について
